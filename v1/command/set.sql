...
DO $$
  BEGIN
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_version(
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_partition(
    ...
    ALTER FUNCTION link_set_partition(
    ...
    */
    CREATE OR REPLACE FUNCTION link_set_role(
      key_param character varying,
      name_param character varying,
      description_param text,
    ...
    */
    CREATE OR REPLACE FUNCTION link_set_user(
        key_param character varying,
        name_param character varying,
    ...
    */
    CREATE OR REPLACE FUNCTION link_add_membership(
        key_param character varying,
    ...
    BEGIN
        -- only users in level 2 roles can create or update other users
        -- if not super admin then raise exception
        PERFORM link_is_super_admin(logged_role_key_param, TRUE);
    ...
    ALTER FUNCTION link_add_membership(
        character varying, -- key
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_model(
         key_param character varying,
         name_param character varying,
         description_param text,
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_item(
        key_param character varying,
        name_param character varying,
        description_param text,
        meta_param jsonb,
    ...
    BEGIN
      ...
      PERFORM link_check_item_attr(item_type_key_param, attribute_param);
      ...
      IF (meta_param IS NOT NULL) THEN
        ...
        IF (meta_schema_value IS NOT NULL) THEN
          SELECT link_validate_json_schema(meta_schema_value, meta_param) INTO is_meta_valid;
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_item_type(
        key_param character varying,
        name_param character varying,
        description_param text,
        filter_param jsonb,
    ...
    ALTER FUNCTION link_set_item_type(
        character varying, -- key
        character varying, -- name
        text, -- description
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_link_type(
        key_param character varying,
        name_param character varying,
        description_param text,
        meta_schema_param jsonb,
    ...
    ALTER FUNCTION link_set_link_type(
      character varying, -- key
      character varying, -- name
      text, -- description
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_link(
      key_param character varying,
    ...
    BEGIN
      ...
      PERFORM link_check_link(link_type_key_param, start_item_type_key_value, end_item_type_key_value);

      -- checks that the attributes passed in comply with the validation in the link_type
      PERFORM link_check_link_attr(link_type_key_param, attribute_param);
     ...
     */
    CREATE OR REPLACE FUNCTION link_set_link_rule(
      key_param character varying,
      name_param character varying,
      description_param text,
      link_type_key_param character varying,
    ...
    ALTER FUNCTION link_set_link_rule(
      character varying,
      character varying,
      text,
      character varying,
    ...
    /*
      link_set_privilege()
    */
    CREATE OR REPLACE FUNCTION link_set_privilege(
      key_param character varying,
      partition_key_param character varying,
      role_key_param character varying,
    ...
    ALTER FUNCTION link_set_privilege(
        character varying,
        character varying,
        character varying,
        boolean,
   ...
   OWNER to interlink;
    ...
    /*
      ...
      Concurrency Management:
       ...
       - If the item type is not found in the database, then the local_version_param is ignored and a record with version 1 is inserted.
     */
    CREATE OR REPLACE FUNCTION link_set_type_attribute(
        key_param character varying,
        name_param character varying,
        description_param text,
    ...
    ALTER FUNCTION link_set_type_attribute(
