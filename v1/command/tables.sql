...
$$
    BEGIN
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_user() RETURNS TRIGGER AS
            $user_change$
            BEGIN
            ...
            CREATE TRIGGER user_change
                ...
                ON "user"
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_user();
        ...
        VALUES (1, 'admin', 'Administrator', 'E2BgmQs4vH4rYvj5Fe0p9DbZUKU=', '8DZMiAR+XGA=', true, 1, 'interlink');
        INSERT INTO "user"(id, key, name, pwd, salt, service, version, changed_by)
        VALUES (2, 'reader', 'Reader', '/EvDpP8kHkfd30mXk+Ne9aA4h5o=', 'B0zo+y0Keiw=', true, 1, 'interlink');
        INSERT INTO "user"(id, key, name, pwd, salt, service, version, changed_by)
        VALUES (3, 'writer', 'Writer', 'DkV3uMWjAjHSTZnW9TkJNI6XOzU=', 'yWJm38+RPtc=', true, 1, 'interlink');
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_partition() RETURNS TRIGGER AS
            $partition_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER partition_change
                ...
                ON partition
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_partition();
        ...
        VALUES (0, 'REF', 'Default Reference Partition', 'Default partition for reference data.', 1, 'interlink');
        INSERT INTO partition(id, key, name, description, version, changed_by)
        VALUES (1, 'INS', 'Default Instance Partition', 'Default partition for instance data.', 1, 'interlink');
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_role() RETURNS TRIGGER AS
            $role_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER role_change
                ...
                ON role
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_role();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_privilege() RETURNS TRIGGER AS
            $privilege_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER privilege_change
                ...
                ON privilege
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_privilege();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_membership() RETURNS TRIGGER AS
            $membership_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER membership_change
                ...
                ON membership
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_membership();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_model() RETURNS TRIGGER AS
            $model_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER model_change
                ...
                ON model
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_model();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_item_type() RETURNS TRIGGER AS
            $item_type_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER item_type_change
                ...
                ON item_type
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_item_type();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_item() RETURNS TRIGGER AS
            $item_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER item_change
                ...
                ON item
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_item();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_link_type() RETURNS TRIGGER AS
            $link_type_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER link_type_change
                ...
                ON link_type
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_link_type();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_link() RETURNS TRIGGER AS
            $link_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER link_change
                ...
                ON link
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_link();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_link_rule() RETURNS TRIGGER AS
            $link_rule_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER link_rule_change
                ...
                ON link_rule
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_link_rule();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_tag() RETURNS TRIGGER AS
            $tag_change$
            BEGIN
                IF (TG_OP = 'DELETE') THEN
            ...
            CREATE TRIGGER tag_change
                ...
                ON tag
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_tag();
        ...
        THEN
            ...
            CREATE OR REPLACE FUNCTION link_change_type_attribute() RETURNS TRIGGER AS
            ...
            CREATE TRIGGER type_attribute_change
                ...
                ON type_attribute
                FOR EACH ROW
            EXECUTE PROCEDURE link_change_type_attribute();
