...
BEGIN
    ...
    /*
     link_get_enc_key_usage: gets the number of items and links that are using a specified encryption key
        i.e. key 1 or key 2 respectively.
        Use this query to understand the state of key rotation at a point in time.
     */
    CREATE OR REPLACE FUNCTION link_get_enc_key_usage(
    ...
    ALTER FUNCTION link_get_enc_key_usage(smallint, character varying[])
        OWNER TO interlink;
